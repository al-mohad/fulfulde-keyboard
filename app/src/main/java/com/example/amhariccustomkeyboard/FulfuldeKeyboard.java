...
public class FulfuldeKeyboard extends InputMethodService implements KeyboardView.OnKeyboardActionListener {
    ...
    public void onCreate() {
        ...
        CustomFontHelper.setDefaultFont(this, "DEFAULT", "fonts/fodi.otf");
        CustomFontHelper.setDefaultFont(this, "MONOSPACE", "fonts/fodi.otf");
        CustomFontHelper.setDefaultFont(this, "SERIF", "fonts/fodi.otf");
        CustomFontHelper.setDefaultFont(this, "SANS_SERIF", "fonts/fodi.otf");

        /*FontsOverride.setDefaultFont(this, "MONOSPACE", "MyFontAsset2.ttf");
        FontsOverride.setDefaultFont(this, "SERIF", "MyFontAsset3.ttf");
        FontsOverride.setDefaultFont(this, "SANS_SERIF", "MyFontAsset4.ttf");*/
//        Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/fulde.ttf");
//        CustomFontHelper.replaceFont("FULDE FODI",tf);
//        CustomFontHelper.getDefaultTypeface();
    }
...
//                break;
        ...
        switch(primaryCode){
            ...
            case Keyboard.KEYCODE_DONE:
                ...
                default:
                    ...
                    Log.d("text", "i: " + primaryCode + " " + String.valueOf(c));

                   inputConnection.setComposingText(String.valueOf(c), 1);
    ...
    private void playClick(int i){
        ...
        audioManage.playSoundEffect(AudioManager.FX_KEYPRESS_STANDARD);

        switch(i){
            case 32:
                audioManage.playSoundEffect(AudioManager.FX_KEYPRESS_SPACEBAR);
                break;
            case Keyboard.KEYCODE_DONE:
            case 10:
                audioManage.playSoundEffect(AudioManager.FX_KEYPRESS_RETURN);
                break;
            case Keyboard.KEYCODE_DELETE:
                audioManage.playSoundEffect(AudioManager.FX_KEYPRESS_DELETE);
                break;
            default: audioManage.playSoundEffect(AudioManager.FX_KEYPRESS_STANDARD);
        }
    }
